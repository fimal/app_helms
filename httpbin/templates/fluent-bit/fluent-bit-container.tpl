...
*/}}
{{ define "httpbin.fluent-bit-container" }}
- name: fluentbit
  image: {{ include "httpbin.image.registry" . | coalesce .Values.containers.fluentbit.registry }}/waas-fluentbit{{ include "httpbin.image.version" . | coalesce .Values.containers.fluentbit.version }}
