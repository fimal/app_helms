...
*/}}
{{ define "bwapp.fluent-bit-container" }}
- name: fluentbit
  image: {{ include "bwapp.image.registry" . | coalesce .Values.containers.fluentbit.registry }}/waas-fluentbit{{ include "bwapp.image.version" . | coalesce .Values.containers.fluentbit.version }}
